...
const Footer = () => {
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content fixed bottom-0 left-0 lg:px-36">
            <div className="items-center grid-flow-col">
                <img src={logo} alt="" className='w-auto h-14'/>
                <p>Copyright © 2022 | Residential Plumber - All right reserved</p>
            </div>
